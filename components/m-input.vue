<template>
	<view class="m-input-view flex-between">
		<input :focus="focus" :type="inputType" :value="value" @input="onInput" class="m-input-input" :placeholder="placeholder" placeholder-class="plh"
