<template>
	<view class="content">
		<uni-nav-bar color="#fff" leftIcon="arrowleft" :fixed="true" @clickLeft="back" :border="false" :statusBar="true"
				...
				<evan-form-item prop="shopName" label="权限" :label-style="labelStyle">
					<view class="flex-center adressInput" style="height:auto">
						<checkbox-group @change="checkboxChange" class="flex-between" style="flex-wrap:wrap">
							...
							<label class="width100 flex">
								<view class="mgr-20">
									<checkbox style="transform:scale(0.8)" :value="3" />
								</view>
								<view class="f30">订单管理</view>
							</label>
							<label class="width100 flex">
								<view class="mgr-20">
									<checkbox style="transform:scale(0.8)" :value="4" />
								</view>
